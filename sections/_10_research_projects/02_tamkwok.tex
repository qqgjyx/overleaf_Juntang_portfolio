...
{EEG/EMG, FFT/Wavelet, Sleep \& Memory, CNN}
{
  ...
  \bitem{Implemented a CNN for EEG/EMG vigilance-state classification achieving >90\% accuracy; compared 10+ existing methods.}
  \bitem{Publications: CNS 2025 (conference) and PNAS Nexus (journal, under review).}
}
...
{\badge{PNAS Nexus under review} \badge{CNS 2025}}
