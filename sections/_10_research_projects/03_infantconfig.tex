...
\begin{figure}[ht]
  ...
  \subcaptionbox{Lineage (schem.)\label{fig:lineage_schem}}[0.25\linewidth]{%
    \input{assets/1003_infantconfig/01a_schematic.tex}%
  }
  ...
  \subcaptionbox{Energy (MNIST)\label{fig:energy_mnist}}[0.237\linewidth]{%
    \input{assets/1003_infantconfig/01c_har_mnist.tex}%
  }
  \subcaptionbox{Energy (WHU)\label{fig:energy_whu}}[0.237\linewidth]{%
    \input{assets/1003_infantconfig/01d_har_whuhi.tex}%
  }
  \caption{
...
\begin{figure}[ht]
  \centering
  \subcaptionbox{Hierarchical Selectivity\label{fig:04_a}}[0.33\linewidth]{\input{assets/1003_infantconfig/04a_.tex}}
  \subcaptionbox{Novelty Detection\label{fig:04_b}}[0.33\linewidth]{\input{assets/1003_infantconfig/04b_.tex}}
  \hspace{-1em}
  \subcaptionbox{Dynamic Evolution\label{fig:04_c}}[0.33\linewidth]{\input{assets/1003_infantconfig/04c_.tex}}
  \caption{
